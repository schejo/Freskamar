...
public class menu extends GenericForwardComposer {
    ...
    public void onClick$ItemBA(Event evt) {
        rootPagina.setSrc("/Vistas/Ventas_1.zul");
    }
    ...
    public void onClick$ItemBD(Event evt) {
        rootPagina.setSrc("/Vistas/Ventas1f.zul");
    }
    ...
    public String getUsuario() {
        ...
        Clients.showNotification("BIENVENIDO AL SISTEMA DE INVENTARIO DE FIESTAS <br/>" + login.USER + " <br/>  <br/>");
